...
public class AddandRemoveCrochetPattern {
    ...
    @Test
    public void addandRemoveCrochetPattern() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView_Name), withText("Name"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class))),
                        isDisplayed()));
        textView.check(matches(isDisplayed()));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView_Description), withText("Desc"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class))),
                        isDisplayed()));
