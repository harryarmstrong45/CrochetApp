package com.example.android.roomwordssample.EspressoTests;
...
import com.example.android.roomwordssample.Login.UserLoginActivity;
...
public class AddPatternTest {
    ...
    public void addPatternTest() {
        ...
        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.fab), withContentDescription("Add Item"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edit_name),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Pattern 1"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edit_Description),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("Pattern 1234"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView_Name), withText("Pattern 1"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("Pattern 1")));
    }
